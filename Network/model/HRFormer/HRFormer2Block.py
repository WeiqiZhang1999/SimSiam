#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2/27/2023 10:02 PM
# @Author  : ZHANG WEIQI
# @File    : HRFormer2Block.py.py
# @Software: PyCharm
...
from .modules.transformer_block import GeneralTransformerBlock, EfficientTransformerBlock
...
blocks_dict = {
    ...
    "TRANSFORMER_BLOCK": EfficientTransformerBlock,
}
